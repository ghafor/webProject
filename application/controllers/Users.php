...
class Users extends Admin_Controller 
{
	...
	public function list_users($start = 0)
	{
		...
		$config['total_rows'] = $this->model_users->count_all('users');
		$config['per_page'] = 5;
		...
		$user_data = $this->model_users->getUserData($start,$config['per_page']);
			...
			if ($this->form_validation->run() == TRUE) {
		        ...
		        if(empty($this->input->post('password')) && empty($this->input->post('cpassword'))) {
					...
					if($this->form_validation->run() == TRUE) {
			            ...
			            // false case
			        	$user_data = $this->model_users->getUserData(null,null,$id);
	...
	public function profile()
	{
		...
		$user_data = $this->model_users->getUserData(null,null,$user_id);
		$this->data['user_data'] = $user_data;
	...
	public function setting()
	{
		...
		if($id) {
			...
			if ($this->form_validation->run() == TRUE) {
	        	...
	        	$user_data = $this->model_users->getUserData(null,null,$id);
	        	$groups = $this->model_users->getUserGroup(null,null,$id);
