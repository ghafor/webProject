  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small><?=$this->lang->line('Category');?></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> <?=$this->lang->line('Home');?></a></li>
        <li class="active"><?=$this->lang->line('Category');?></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('createCategory', $user_permission)): ?>
            <button class="btn btn-primary" data-toggle="modal" data-target="#addModal"><?=$this->lang->line('Add_Category');?></button>
            <br /> <br />
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><?=$this->lang->line('Manage_Category');?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?=$this->lang->line('Add_Category');?></h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('category/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary"><?=$this->lang->line('Save changes');?></button>
        </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?=$this->lang->line('Edit_Category');?></h4>
      </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?=$this->lang->line('Remove_Category');?></h4>
      </div>

      <form role="form" action="<?php echo base_url('category/remove') ?>" method="post" id="removeForm">
        <div class="modal-body">
          <p><?=$this->lang->line('Do_you_really_want_to_remove?');?></p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal"><?=$this->lang->line('Close');?></button>
          <button type="submit" class="btn btn-primary"><?=$this->lang->line('Save_changes');?></button>
